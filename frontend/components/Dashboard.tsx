...
export default function Dashboard() {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <main style={{ flex: 1, minWidth: 0, padding: "28px 32px 60px", overflowX: "hidden" }}>
        {/* Header */}
        <div style={{
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ fontFamily: "Syne, sans-serif", fontWeight: 800, fontSize: 28, color: "#4285F4", letterSpacing: "-0.03em" }}>
                AQI
              </span>
              <span style={{ color: "var(--muted)", fontSize: 13 }}>
                Surveillance PM2.5 & PM10 · Cotonou, Bénin
              </span>
            </div>
            <h1 style={{ fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: 18, color: "var(--text)", margin: "4px 0 0", letterSpacing: "-0.02em" }}>
                Indice de Qualité de l'Air (AQI) à Littoral · Pollution de l'Air
            </h1>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div className="live-dot" />
            <span style={{ fontSize: 11, color: "var(--muted)", fontFamily: "JetBrains Mono, monospace" }}>
              {loading ? "Chargement…" : `${records.length.toLocaleString("fr")} mesures`}
            </span>
          </div>
        </div>
